...
Write-Host "============================ By Brooks Peppin   ================================="
Write-Host "========================== www.brookspeppin.com ================================="
Write-Host "========================== Updated Sept, 1 2023 ================================="
Write-Host "================================================================================="`n
Write-Host "This script creates a bootable Windows 10/11 media usb key that installs
Windows 10/11 automatically via an autounattend.xml file. It supports booting with 
...
Write-host "Would you like to add the autounattend.xml to the USB to enable zero-touch install? (This will prompt you again at the end)" -foreground "yellow"
